            ...
            <div id="login-form">
                <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <span class="input-group-addon"><textarea class="glyphicon glyphicon-lock" name="body" id="body" rows="20" cols="50" placeholder="Provide a brief outline of the aims and objectives of the proposed research project." maxlength="50"></textarea></span>
